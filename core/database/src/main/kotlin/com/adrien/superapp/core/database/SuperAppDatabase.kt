 ...
 * PROJECT_STATUS.md §Blocages), so Phase 3's new entities are added to the same version rather
 * than authoring a `Migration` no installed copy of the app will ever need.
 */
@Database(
    entities = [
        ProfileEntity::class,
